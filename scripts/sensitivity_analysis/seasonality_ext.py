...
argparser.add_argument(
    ...
    type=int,
    default=None,
    help="The degree of the fourier expansion of seasonality (0 = default simple cosine seasonality implementation)",
)
...
if __name__ == "__main__":
    ...
    assert (args.interactions is not None) != (args.fourier_degree is not None)

    if args.fourier_degree is not None:
        assert args.fourier_degree > 0 and args.fourier_degree < 100
        model_func = seasonality_fourier_model
    else:
        model_func = seasonality_interactions_model
    ...
    if args.interactions is not None:
        ...
        model_build_dict["interactions"] = args.interactions
    if args.fourier_degree is not None:
        model_build_dict["fourier_degree"] = args.fourier_degree
